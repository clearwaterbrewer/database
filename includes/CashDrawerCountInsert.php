...
//      header('Location: ../CDC_CashDrawerCount.php');
      $insertDrawerCount = null;
		echo $_POST["DateTimeCode"] . ", " . $_POST["Initials"] . ", " . echo $_POST["CountOpen"] . ", " . echo $_POST["bill_100"] . 
		", " . echo $_POST["bill_50"] . ", " . echo $_POST["bill_20"] . ", " . echo $_POST["bill_10"] . ", " . echo $_POST["bill_5"] . 
		", " . echo $_POST["bill_1"] . ", " . echo $_POST["coin_100"] . ", " . echo $_POST["coin_25"] . ", " . echo $_POST["coin_10"] . 
		", " . echo $_POST["coin_5"] . ", " . echo $_POST["coin_1"] . ", " . echo $_POST["CountClose"] . ", " . echo $_POST["CountDelta"] . 
		", " . echo $_POST["POS_Amount"] . ", " . echo $_POST["POS_Tip"] . ", " . echo $_POST["POS_Due"] . PHP_EOL;
      } 
  else{
