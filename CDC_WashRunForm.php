  ...
  <ul class="form-section page-section">
    ...
    <li class="form-line" data-type="control_textbox">
        ...
        <label for="PGCollected">PG Collected</label>
          <input type="text" inputmode="numeric" pattern="^\d{1,3}(\.\d{0,1})?$" size="5" class="form-control" id="PGCollected" name="PGCollected" value="">
        <label  for="PGEfficiency">PG Efficiency</label>
          <input type="text" inputmode="numeric" pattern="^\d{1,3}(\.\d{0,1})?$" size="5" class="form-control" id="PGEfficiency" name="PGEfficiency" value="">
        </div>
    </li>
    <li class="form-line" data-type="control_textbox">
        <div class="form-input-wide">
