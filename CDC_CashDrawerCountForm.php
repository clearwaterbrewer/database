    ...
    <li class="form-line" data-type="control_textbox">
       ...
       <label for="DateTimeCode">DateTimeCode</label>
        ...
        <label for="CountOpen">Opening Count</label>
          <input type='text' inputmode="numeric" class='form-control' id="CountOpen" name="CountOpen" value="" />
       </div>
    </li>
  ...
  <ul class="form-section page-section" >
    <li class="form-line" data-type="control_text" >
      <div class="buttonrow">
          ...
          <a href="CDC_CashDrawerCount.php.php"><button type="button" class="form-submit-button">Back to Drawer Counts</button></a>
